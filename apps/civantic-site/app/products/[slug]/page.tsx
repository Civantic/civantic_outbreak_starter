...
export const metadata: Metadata = {
  ...
  description: "Practical toolkits that turn policy into repeatable practice. Join the beta for early access to Civantic toolkits.",
    ...
    <div>
      <section className="container py-16 md:py-24 text-center">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          <a href="https://outbreakresponse.com" className="btn btn-outline" target="_blank" rel="noopener noreferrer">
      ...
      <section className="container pb-24">
        ...
        <p className="mt-3 text-center text-sm text-gray-600">
          ...
          <a href="https://outbreakresponse.com" className="ml-2 text-brand-700 hover:underline" target="_blank" rel="noopener noreferrer">
