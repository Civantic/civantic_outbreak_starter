  ...
  return (
    <section className="container py-16 md:py-24">
      <div className="mx-auto max-w-3xl prose">
        ...
        <p>If third-party checkout, analytics, or embeds are used, their respective policies apply in addition to this page. You can request updates or deletion of your information at any time.</p>
